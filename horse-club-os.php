...
require_once HCOS_PLUGIN_DIR . 'includes/class-hcos-login.php';
require_once HCOS_PLUGIN_DIR . 'includes/class-hcos-mail.php';
...
require_once HCOS_PLUGIN_DIR . 'includes/class-hcos-clients-screen.php';
require_once HCOS_PLUGIN_DIR . 'includes/class-hcos-horses-screen.php';
require_once HCOS_PLUGIN_DIR . 'includes/class-hcos-trainers-screen.php';
require_once HCOS_PLUGIN_DIR . 'includes/class-hcos-services-screen.php';
...
require_once HCOS_PLUGIN_DIR . 'includes/class-hcos-memberships-screen.php';
require_once HCOS_PLUGIN_DIR . 'includes/class-hcos-bookings.php';
require_once HCOS_PLUGIN_DIR . 'includes/class-hcos-bookings-screen.php';
